  ...
  return (
      <main>
        ...
        <div className="rates-grid">
            ...
            <p>I trade</p>
            <input type="text" placeholder='20%' onChange={(e) => setTradeRate(parseFloat(e.target.value))}/>

            <input type="checkbox"  checked={income} onChange={(e) => setIncome(e.target.checked)}/>
            <p>I receive income</p>
            <input type="text" placeholder='20%' onChange={(e) => setIncomeRate(parseFloat(e.target.value))}/>

            <input type="checkbox"  checked={donation} onChange={(e) => setDonation(e.target.checked)}/>
            <p>I donate</p>
            <input type="text" placeholder='10%' onChange={(e) => setDonationRate(parseFloat(e.target.value))}/>
        </div>
