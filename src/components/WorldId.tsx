...
const WorldId: React.FC<WorldIdProps> = () => {
  ...
  const worldIdClickHandler = () => {
    ...
    console.log(nonce);
    window.location.href = `https://id.worldcoin.org/login?response_type=code&response_mode=query&client_id=app_7cbc22f80e20373856dd02a25468805f&redirect_uri=https://staxer.vercel.app/worldcoin&ready=true&scope=openid&nonce=${nonce}`;
  };
